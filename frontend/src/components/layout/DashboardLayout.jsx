...
export default function DashboardLayout() {
    ...
    const navItems = [
        ...
        { label: 'Bookmarks', path: '/bookmarks', icon: HiOutlineBookmark, activeIcon: HiOutlineBookmark },
            ...
            <div className="flex-1 flex layout-container w-full">
                ...
                <aside className="hidden lg:flex w-64 bg-white border-r border-slate-200 flex-col sticky top-0 h-screen overflow-y-auto">
                    ...
                    <div className="mt-auto p-4 border-t border-slate-100 space-y-1">
                         <button onClick={() => {}} className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-colors">
                            <HiOutlineCog6Tooth className="w-5 h-5 text-slate-400" /> Settings
                        </button>
